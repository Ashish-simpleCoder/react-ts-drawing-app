...
export default function useCanvasDrawing() {
   ...
   const [finalPaths, setFinalPaths] = useLocalStorage<Array<[number, number][]>>('finalPaths', [])
   ...
   const stopDrawing = useCallback(() => {
      ...
      flushSync(() => {
         // setFinalPaths((paths) =>{
         //    paths.push(currentWorkingPathRef.current)
         //    return paths
         // })
         finalPaths.push(currentWorkingPathRef.current)
